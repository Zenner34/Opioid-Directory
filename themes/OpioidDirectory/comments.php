...
<strong><?php comment_author_link() ?></strong>, <?php _e('on'); ?> <?php comment_date('F jS, Y') ?> <?php _e('at');?> <?php comment_time() ?> <?php _e('Said&#58;'); ?> <?php edit_comment_link('Edit Comment','',''); ?>
...
<p><input class="form-control" name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" />
